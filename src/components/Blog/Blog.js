    ...
    return (
        <div className='blog-container'>
          ...
          <div>
                ...
                <div className='w-50 text-start fs-4'>
                    <h3 className='diff-title text-center'>Block-level Elements</h3>
